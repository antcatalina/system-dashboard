    ...
    >
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <div
            className="live-dot"
            style={{ backgroundColor: "#00ff9d", color: "#00ff9d" }}
          />
          <span className="label-text">CPU</span>
          <span
            className="badge"
            style={{ color: "#00ff9d", borderColor: "rgba(0,255,157,0.3)" }}
          >
            {cpu.cores}C / {cpu.threads}T
          </span>
          <span className="font-sans text-xl text-white/50 truncate ml-1">
            {cpu.model}
          </span>
        </div>
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <span className="font-display text-xl font-bold text-accent-green glow-green">
            {ghz}
            <span className="font-mono text-sm ml-1 opacity-60">GHz</span>
          </span>
        </div>
      </div>
      ...
      {/* ── Gauges ── */}
      <div
        className="flex justify-around items-center px-4 py-5"
      ...
      >
        <div className="flex justify-between items-center mb-3">
          ...
          <span className="font-mono text-2xl" style={{ color: lc }}>
          ...
          {(cpu.perCore.length > 0
            ...
            return (
              <div key={core.core} className="flex flex-col items-center gap-1">
                ...
                <span className="font-mono text-[16px] text-white/20">
                  {core.core + 1}
                </span>
              </div>
            );
